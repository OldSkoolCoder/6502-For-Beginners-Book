...
FoundSomeDoors:
    ...
    cmp #DIRECTION_Down         // Was it the South Door
    bne TryNorthDoor            // No, lets try the North Door
...
TryNorthDoor:
    cmp #DIRECTION_Up           // Was it the North Door
    bne TryEastDoor             // No, lets try the East Door
...
TryEastDoor:
    cmp #DIRECTION_Right        // Was it the East Door
    bne TryWestDoor             // No, lets try the West Door
...
WorkOutMazeLocation:
{
    ...
    lda #>MazeArray             // Load the Hi Address Value of the Maze Array
